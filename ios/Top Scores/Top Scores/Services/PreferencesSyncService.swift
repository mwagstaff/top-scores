    ...
    func fetchPreferences(apiBaseURL: String) async -> PreferencesSnapshot? {
        ...
        do {
            ...
            let snapshot = PreferencesSnapshot(
                ...
                notificationMajorUEFAClubGamesEnabled: preferences["notificationMajorUEFAClubGamesEnabled"] as? Bool ?? PreferencesStore.defaultNotificationMajorUEFAClubGamesEnabled,
                notificationHomeNationsFilterEnabled: preferences["notificationHomeNationsFilterEnabled"] as? Bool ?? PreferencesStore.defaultNotificationHomeNationsFilterEnabled,
                notificationMajorTournamentsFilterEnabled: preferences["notificationMajorTournamentsFilterEnabled"] as? Bool ?? PreferencesStore.defaultNotificationMajorTournamentsFilterEnabled,
