...
module.exports = {
  ...
  upsertTvListings: mongoStore.upsertTvListings,
  getAllTvListings: mongoStore.getAllTvListings,
  purgeStaleTvListings: mongoStore.purgeStaleTvListings,
  upsertLeagues: mongoStore.upsertLeagues,
  upsertTsdbLeagueTables: mongoStore.upsertTsdbLeagueTables,
  getAllTsdbLeagueTables: mongoStore.getAllTsdbLeagueTables,
  upsertMatchLineupCache: mongoStore.upsertMatchLineupCache,
  getMatchLineupCache: mongoStore.getMatchLineupCache,
  upsertMatchTimelineCache: mongoStore.upsertMatchTimelineCache,
  getMatchTimelineCache: mongoStore.getMatchTimelineCache,
  upsertTeamCache: mongoStore.upsertTeamCache,
  getTeamCache: mongoStore.getTeamCache,
  getTeamCaches: mongoStore.getTeamCaches,
  upsertPlayerCache: mongoStore.upsertPlayerCache,
  getPlayerCache: mongoStore.getPlayerCache,
  getPlayerCaches: mongoStore.getPlayerCaches,
  getTsdbCacheObservabilitySnapshot: mongoStore.getTsdbCacheObservabilitySnapshot,
