...
test("buildPrometheusMetricsText includes top-scores runtime health metrics", () => {
  ...
  [
    ...
    "top_scores_bsd_http_top_url_requests",
    "top_scores_bsd_http_timeout_url_requests",
    "top_scores_bsd_http_slow_url_p95_seconds",
    ...
    "top_scores_live_football_tv_listings",
